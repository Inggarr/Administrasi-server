...
3. Proses Upload File Folder Standalone
   ...
   - ekstrak file hasil archive
     1. Install tools Unzip di EC2
        - sudo apt install unzip -y ![alt text](image-6.png)
     2. cd /var/www/html
...
5. Seseuaikan isi file .env di file zilla ![alt text](image-12.png)  
   - masukan user pw dll nya sesuaikan ![alt text](image-13.png)

6. di Terminal SSH cd ke folder standalone run apps
   - exit database
   - cd standalone
   - pm2 start server.js ![alt text](image-14.png)
   - pm2  ![alt text](image-15.png)
...
8. Akses Web Compro dengan memasukan IP Public EC2 AWS dan port 3000
   ...
   - berita berhasil di buat ![alt text](image-18.png)
